package com.techblog.security.filter;
 ...
 * Filter mỗi HTTP request để kiểm tra JWT token trong header.
...
public class JwtAuthenticationFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(
        ...
        try {
            ...
            log.error("Could not set user authentication in JWT filter", e);
        }
